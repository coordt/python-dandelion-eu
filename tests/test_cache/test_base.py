...
class FakeDandelionRequest(BaseDandelionRequest):
    ...
    def do_request(self, *args, **kwargs):
        ...
        return super(FakeDandelionRequest, self).do_request(*args, **kwargs)

    def _do_raw_request(self, url, params, method, **kwargs):
        self.last_cache_status = "miss"
        return FakeResponse(ok=True, content=json.dumps(dict(url=url, params=params)))
...
class CacheBaseMixin:
    ...
    def test_simple(self):
        ...
        self.assertEqual(
            resp,
            {
                "url": "https://api.dandelion.eu/method1",
                "params": {
                    "param1": "1",
                    "param2": "2",
                },
        ...
        self.assertEqual(
            resp,
            {
                "url": "https://api.dandelion.eu/method2",
                "params": {
                    "foo": "bar",
                },
            },
